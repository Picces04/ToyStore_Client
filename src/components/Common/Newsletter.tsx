                ...
                <div className="relative z-1 overflow-hidden rounded-xl">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 px-4 sm:px-7.5 xl:pl-12.5 xl:pr-14 py-11">
                        <div className="max-w-[491px] w-full">
                            <h2 className="max-w-[430px] text-white font-bold text-lg sm:text-xl xl:text-heading-4 mb-3">
                                Đừng bỏ lỡ các xu hướng và ưu đãi mới nhất
                            </h2>
                            <p className="text-white">
                                Đăng ký để nhận tin tức về ưu đãi & mã giảm giá
                                mới nhất
                            </p>
                        </div>
                        ...
                        <div className="max-w-[477px] w-full">
                            <form>
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="inline-flex w-30 justify-center py-3 px-2 text-white bg-blue font-medium rounded-md ease-out duration-200 hover:bg-blue-dark"
                                    >
                                        Đăng ký
                                    </button>
                                </div>
