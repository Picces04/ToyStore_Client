    ...
    useEffect(() => {
        const fetchProductDetail = async () => {
            try {
                ...
                const response = await api.get(`/api/Product/${key}`);
                                ...
                                <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                                    ...
                                    <div className="w-full">
                                        <p className="text-sm sm:text-base text-dark">
                                            ...
                                            wireless (MagSafe), 7.5W wireless
                                            (Qi)
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div className="max-w-[550px] w-full">
                                    <form>
                                        ...
                                        <p className="mb-6">
                                            Địa chỉ email của bạn sẽ không được
                                            công bố. Các trường bắt buộc được
                                            đánh dấu *
                                        </p>
